...
import com.lawencon.e.learning.dto.exception.ExceptionDto;
...
public class ErrorHandler {
	...
	public ResponseEntity<ExceptionDto<String>> runtimeException(DataIntegrityViolationException re){
		
		
		final ExceptionDto<String> exceptionDto = new ExceptionDto<>();
		exceptionDto.setMessage("Data Empty / Duplicate");
